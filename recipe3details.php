...
<body>
        <div class='recipe-card' data-recipe-id="9" id='recipe_id' key='9'>
        <div style="background:url('./images/food3.jpg') no-repeat 50% 50%; background-size:cover; height: 300px"></div>
        <div class="recipe-card__body">
            <h1 class="recipe-card__heading">Pumpkin Spice Latte</h1>
            <h2 class="recipe-card__subhead">Warm and comforting pumpkin spice latte, perfect for fall.</h2>
            <div class="favorite">
