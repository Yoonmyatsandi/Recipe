...
<body>
        <div class='recipe-card' data-recipe-id="21" id='recipe_id' key='21'>
        <div style="background:url('./images/food3.jpg') no-repeat 50% 50%; background-size:cover; height: 300px"></div>
        <div class="recipe-card__body">
            <h1 class="recipe-card__heading">Thai Coconut Milk Soup (Tom Kha Gai)</h1>
            <h2 class="recipe-card__subhead">A comforting and fragrant Thai soup with coconut milk and chicken.</h2>
            <div class="favorite">
